...
df_true=pd.read_csv('data/climate/true_generative.csv', sep=',',header=None)
df_deriv=pd.read_csv('data/climate/pos_generative.csv', sep=',',header=None)
df_org=pd.read_csv('data/climate/prior_generative.csv', sep=',',header=None)
# df_org_c=pd.read_csv('data/climate/prior_generative_var.csv', sep=',',header=None)
# df_deriv_c=pd.read_csv('data/climate/pos_generative_var.csv', sep=',',header=None)
df_org_r=pd.read_csv('data/climate/prior_generative_rand.csv', sep=',',header=None)
N = (df_true.shape)[0]
iter = (df_deriv.shape)[0]//N
rand_N = (df_org_r.shape)[0]//N

df_deriv_r_chunks = pd.read_csv('data/climate/pos_generative_rand.csv', sep=',',header=None, chunksize=(N*rand_N))
